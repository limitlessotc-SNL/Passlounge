...
describe('useAuth', () => {
  ...
  it('login sets user in store on success', async () => {
  ...
  it('signup sets user in store on success', async () => {
    ...
    await act(async () => {
      await result.current.signup({ email: 'new@b.com', password: 'pw' })
    })
  ...
  it('signup sets error on failure', async () => {
    ...
    await act(async () => {
      await result.current.signup({ email: 'a@b.com', password: 'pw' })
    })

    expect(result.current.error?.message).toBe('Email taken')
  })

  it('forgotPassword sets resetSent on success', async () => {

...
export function TestDateScreen() {
  ...
  return (
    <div className="content">
      ...
      <button className="back-btn" onClick={() => navigate('/onboarding/confidence')}>
      ...
      <div className="screen-sub">Enter your date — we activate your countdown clock immediately.</div>
